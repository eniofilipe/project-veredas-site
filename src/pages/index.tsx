      ...
      <S.HomeSectionWrapper ref={sectionOneRef}>
        <S.BGHome>
          <S.CentralizeWrapper>
            ...
            <p>Direto do campo da agricultura familiar.</p>
      ...
      <S.WrapperSecondSection>
        <S.Card1>
          ...
          <p>
            ...
            livres de agrotóxicos, trazendo mais segurança, saúde e qualidade de
            vida. <br />
            Tudo isso para que você no conforto da sua casa, receba os melhores
            produtos da região!
          </p>
        </S.Card1>
      ...
      <S.WrapperThreeSection>
        ...
        <S.TextDivPrincipal>
          <S.TextDiv1>
            ...
            <p>
              &nbsp; Escolha o produto, a quantidade e adicione ao carrinho.{' '}
            </p>
