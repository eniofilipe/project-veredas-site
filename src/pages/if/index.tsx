      ...
      <S.WrapperBody>
        <div className="card">
          ...
          <div className="info">
            ...
            <a href="https://www.ifnmg.edu.br/cursos/38-portal/montes-claros/montes-claros-cursos/3378-curso-de-bacharelado-em-ciencia-da-computacao">
        ...
        <div className="card">
          ...
          <div className="info">
            <h1>João Kevin</h1>
            <a href="https://www.linkedin.com/in/joao-kevin-gomes-rodrigues/">
              LinkedIn
            </a>
        ...
        <div className="card">
          ...
          <div className="info">
            <h1>Jefeson</h1>
            <a href="https://www.linkedin.com/in/jefeson-martins-062a0b152/">
              LinkedIn
            </a>
        ...
        <div className="card">
          ...
          <div className="info">
            <h1>Deise</h1>
            <a href="https://www.linkedin.com/in/deise-santana-503704158/">
              LinkedIn
            </a>
